...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/au1996/vue2-element-admin')).toBe(true)
    expect(validURL('http://github.com/au1996/vue2-element-admin')).toBe(true)
    expect(validURL('github.com/au1996/vue2-element-admin')).toBe(false)
  })
  it('validLowerCase', () => {
